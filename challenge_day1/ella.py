...
def paragraph8():
    ...
    story = f"Tuesday was a fun autumn day for everyone so.... On Tuesday {name_Jane} went to a bar. {name_Jack} biked through town. Jenny went to a museum. {name_Janine} walked through the center. {name_Jeremy} went to a cozy café. {name_John} met his date at a Spani restauroont."
    return story 
