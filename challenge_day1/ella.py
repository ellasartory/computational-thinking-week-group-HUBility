...
def paragraph3(name_Jack, name_Jenny, name_Jeremy, name_Janine, name_John, name_Jane):
    ...
    story = f"On Wednesday in the summer. {name_Jack} ate some oranges. {name_Jenny} decided to bake some cookies. {name_Jeremy} ate some nice french fries. {name_Janine} had some nice cola. {name_John} ate a good apple. {name_Jane} had some expensiveaa looobster."
    return story 
...
def paragraph13(name_Jack, name_Jenny, name_Jeremy, name_Janine, name_John, name_Jane):
    ...
    story = f"It was winter. Monday was a regular day. On Monday {name_Jeremy} went swimming. {name_Janine} went to play soccer. {name_Jane} went for a run. {name_John} went canoeing. {name_Jenny} Played tennis and {name_Jack} was sick so he laid the entire day at beed."
